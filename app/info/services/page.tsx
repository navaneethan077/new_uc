  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-primary/5">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, var(--primary) 0%, oklch(0.25 0.08 250) 100%)",
        }}
      >
      ...
      <div className="flex-1 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="rounded-xl p-8 text-primary-foreground text-center"
            style={{
              background:
                "linear-gradient(135deg, var(--primary) 0%, oklch(0.25 0.08 250) 100%)",
            }}
          >
            ...
            <p className="mb-6 opacity-90 max-w-2xl mx-auto">
              Our dedicated support team is here to help you navigate our
              services and find exactly what you need.
            </p>
