...
// Interfaces for Notices and Announcements
...
// API Service for Notices (similar to your courseService)
...
const mockNotices: Notice[] = [
  {
    ...
    body: "There will be a temporary water supply interruption in the central area due to maintenance work.",
  ...
  },
  {
    ...
    body: "The deadline for property tax payments has been extended until the end of the month.",
    category: "Taxation",
...
const mockAnnouncements: Announcement[] = [
  {
    ...
    description: "Emergency meeting to discuss recent developments",
  ...
  },
  {
    ...
    description: "Public hearing for the new urban development plan",
...
export default function NoticesPage() {
  ...
  // Using mock data - replace with actual API calls
  ...
  const filteredAndSortedNotices = useMemo(() => {
    ...
    return filtered
  }, [timeFilter, searchTerm, selectedCategories, notices])
                        ...
                        <div className="p-4 md:p-6">
                          ...
                          {notice.attachment && (
                            <div className="mt-3 flex items-center gap-2 text-sm text-gray-500">
                              ...
                              <button
                                onClick={() => handleDownload(notice.attachment!, notice.title)}
                                className="text-[oklch(0.08_250)] hover:underline font-medium"
                              >
                                Download PDF
                              </button>
                            </div>
