...
export default function NoticesPage() {
  // --- local state (focused on Notices) ---
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="container mx-auto px-4 relative z-10 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Official Notices</h1>
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between gap-4 mb-3">
                          <div>
                            ...
                            <div className="text-sm text-gray-500 flex flex-wrap gap-3">
                              <span className="flex items-center gap-2">
                                ...
                                {new Date(notice.dateIssued).toDateString()}
                              </span>
                              {notice.deadline && (
                                <span className="flex items-center gap-2">
                                  <Clock className="w-4 h-4" />
                                  Deadline: {new Date(notice.deadline).toDateString()}
                                </span>
                              )}
                          ...
                          <div className="text-sm text-gray-500 text-right">
                            {notice.refNo && <div className="mb-1">Ref: {notice.refNo}</div>}
                            <div className="mt-2">
                              <button className="text-[oklch(0.2_0.08_250)] hover:underline text-sm font-medium flex items-center gap-2">
                                View
                        ...
                        {notice.attachment && (
                          <div className="mt-2">
                            <a
                              ...
                              className="text-sm underline text-[oklch(0.2_0.08_250)]"
                            >
                              View attachment
                            </a>
                          </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-32">
                <h2 className="text-2xl font-bold text-[oklch(0.2_0.08_250)] mb-6 flex items-center gap-2">
                  <Megaphone className="w-6 h-6 text-[oklch(0.2_0.08_250)]" />
                  High Priority Announcements
                </h2>

                <div className="space-y-4">
                  {highPriorityAnnouncements.length === 0 ? (
                    <p className="text-sm text-gray-500">No high priority announcements at the moment.</p>
                  ) : (
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <h4 className="font-semibold text-gray-800 mb-1 line-clamp-1">{a.title}</h4>
